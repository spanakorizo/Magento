            ...
            if ($product->getTypeId() == Mage_Catalog_Model_Product_Type::TYPE_SIMPLE) {
                ...
                if ($product->getId() && $product->isVisibleInCatalog()) {
                    try {
                        ...
                        $html_response .= "<div class='one_fifth'><a href='" . $product->getProductUrl() . "'><img class='block_center' style='width:75px;height:75px;' src='" . $product->getImageUrl() . "'></img></a></div><div class='two_fifth'><a href='" . $product->getProductUrl() . "'><p class='ti_product_blockName'>" . $product->getProductNameShort() . "</p></a></div><div class='two_fifth text_center'><div class='f-half'><p>Qty: ".$qty."</p></div><div class='f-half'><p>$".$qty * $product->getPrice()."</p></div></div><div class='ti_cms_separator'></div>";
                ...
                if ($product->getId() && $product->isVisibleInCatalog()) {
                    try {
                        ...
                        $cart->addProduct($product,$params);
                         //return added product information
                        $html_response .= "<div class='one_fifth'><a href='" . $product->getProductUrl() . "'><img class='block_center' style='width:75px;height:75px;' src='" . $product->getImageUrl() . "'></img></a></div><div class='two_fifth'><a href='" . $product->getProductUrl() . "'><p class='ti_product_blockName'>" . $product->getName() . "</p></a></div><div class='two_fifth text_center'><div class='f-half'><p>Qty: ".$qty."</p></div><div class='f-half'><p>$".$qty * $product->getPrice()."</p></div></div><div class='ti_cms_separator'></div>";
