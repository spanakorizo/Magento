...
/**
 * Compandsave_Coupon_Model_Validator
 *
 ...
 */
class  Compandsave_Coupon_Model_Validator extends Mage_Core_Model_Abstract
{
    /**
    ...
    /**
     * Defines if method Compandsave_Coupon_Model_Validator::reset() wasn't called
     * Used for clearing applied rule ids in Quote and in Address
     *
     * @var bool
     */
     ...
     * @return  Compandsave_Coupon_Model_Validator
     */
     ...
     * @return  Mage_SalesRule_Model_Validator
     */
    public function process(Mage_Sales_Model_Quote_Item_Abstract $item, $flag = 0)
    {
        ...
        foreach ($this->_getRules() as $rule) {
            ...
            /**
             * Dsiable auto coupon apply with each coupon codes
             */
            if($flag == 1){
           ...
           // $appliedCoupons[$rule->getRuleId()] = $rule->getCode();
