<?php
class Compandsave_Functions_Adminhtml_SpecialfilterController
    extends Mage_Adminhtml_Controller_Action
{
    ...
    public function indexAction()
    {
        ...
        $block = $this->getLayout()->createBlock('adminhtml/template')->setTemplate('cas_functions/specialfilter/view.phtml');
