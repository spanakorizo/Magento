...
//set shipping address
    ...
    $print_text .= $shippingaddress->getFirstname() . "&nbsp" . $shippingaddress->getLastname() . "<br>" . $shippingaddress->getStreetFull() . "<br>" . $shippingaddress->getCity() . "," . $shippingaddress->getRegion() . "&nbsp;" . $shippingaddress->getPostcode() . "<br>" . $shippingaddress->getCountryId() . "<br>" . $shippingaddress->getTelephone() . "</b></font></td></tr></table></td></tr></table><br><table width='602' border='0' cellspacing='0' cellpadding='1' bgcolor='#EEEEEE'> <tr> <td><table cellspacing='0' cellpadding='2' width='100%' border='0' bgcolor='#FFFFFF'><tr> <td width='50%' bgcolor='#EEEEEE'><b>Payment Method:</b></td><td width='50%' bgcolor='#EEEEEE'><b>Shipping Method:</b></td></tr></table><table cellspacing='0' cellpadding='2' width='100%' border='0'> <tr> <td colspan=2><img src='//www.compandsave.com/v/vspfiles/templates/10/images/pixel_black.gif' height='2' width='100%'></td></tr></table><table cellspacing='0' cellpadding='5' width='100%' border='0' bgcolor='#FFFFFF'><tr valign='top'><td width='50%' bgcolor='#F9F9F9'><input type='hidden' class='pciaas_NumberPart'/><b>Credit Card</b>:&nbsp;<span class='span_CardType'>" . $payment_method . "</span><br>" . $cclast . "<br></td><td width='50%' bgcolor='#F9F9F9'>" . $order->getShippingDescription() . "</td></tr></table></td></tr></table><br>";
