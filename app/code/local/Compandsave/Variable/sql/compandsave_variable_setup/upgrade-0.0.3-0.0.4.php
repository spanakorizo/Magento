...
$tableName = $installer->getTable('compandsave_variable/productselectors');
...
$table = $installer->getConnection()->newTable($tableName)
    ...
    ->addIndex(
        $installer->getIdxName(
            array('compandsave_variable/productselectors'),
            array('brand_id'),
            Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE
        ),
        array('brand_id'),
        array('type' => Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE))
    ->setComment('Compandsave Variable Productselectors Table');
