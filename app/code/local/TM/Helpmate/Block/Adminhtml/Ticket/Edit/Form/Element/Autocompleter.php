<?php
class TM_Helpmate_Block_Adminhtml_Ticket_Edit_Form_Element_Autocompleter extends Varien_Data_Form_Element_Text
{
    protected $_url = '';
    ...
    public function getHtml()
    {
        ...
        $hidden = new Varien_Data_Form_Element_Hidden($options);
