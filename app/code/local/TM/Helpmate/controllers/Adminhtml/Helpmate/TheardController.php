...
class TM_Helpmate_Adminhtml_Helpmate_TheardController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function editAction()
    {
        ...
        $model = Mage::getModel('helpmate/theard')->load($id);
        ...
        Mage::register('helpmate_theard_data', $model);
...
//        Zend_Debug::dump($id);
//        Zend_Debug::dump($this->getUrl('adminhtml/helpmate_ticket/edit', array('id' => $ticketId)));
...
//        die;
        if ($id > 0) {
            try {
                ...
                $this->_redirect('adminhtml/helpmate_ticket/edit', array('id' => $ticketId));
            } catch (Exception $e) {
                Mage::getSingleton('adminhtml/session')->addError($e->getMessage());
