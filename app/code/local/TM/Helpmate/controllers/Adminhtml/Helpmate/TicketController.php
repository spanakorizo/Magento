...
class TM_Helpmate_Adminhtml_Helpmate_TicketController extends Mage_Adminhtml_Controller_Action
{
...
//
        ...
        if(!is_array($ticketIds)) {
            ...
            try {
                ...
                foreach ($ticketIds as $tickewtId) {
                    Mage::getSingleton('helpmate/ticket')
                        ->load($tickewtId)
                        ->setStatus($status)
    ...
    /**
     * Gets the list of most active tickets for dashboard
     *
     */
