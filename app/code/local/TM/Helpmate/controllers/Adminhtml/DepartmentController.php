...
class TM_Helpmate_Adminhtml_DepartmentController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function editAction()
    {
        ...
        $this->_addContent(
            $this->getLayout()->createBlock(
                'helpmate/adminhtml_department_edit'
            )
        );
        $this->renderLayout();
    }
...
//
    public function massDeleteAction() {
        $departmentIds = $this->getRequest()->getParam('helpmate');
        if(!is_array($departmentIds)) {
            ...
            try {
                foreach ($departmentIds as $departmentId) {
                    $department = Mage::getModel('helpmate/department')->load($departmentId);
                    $department->delete();
                }
                Mage::getSingleton('adminhtml/session')->addSuccess(
