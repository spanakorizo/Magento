...
class TM_KnowledgeBase_Adminhtml_Knowledgebase_CategoryController extends Mage_Adminhtml_Controller_Action
{
...
//
    ...
    public function exportCsvAction()
    {
        ...
        $content    = $this->getLayout()
            ->createBlock('knowledgebase/adminhtml_category_grid')
            ->getCsv();
