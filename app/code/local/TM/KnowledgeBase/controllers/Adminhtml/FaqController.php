...
class TM_KnowledgeBase_Adminhtml_FaqController extends Mage_Adminhtml_Controller_Action
{
...
//    }
    ...
    public function editAction()
    {
        ...
        $this
            ->_addContent($this->getLayout()->createBlock('knowledgebase/adminhtml_faq_edit'))
            ->_addLeft($this->getLayout()->createBlock('knowledgebase/adminhtml_faq_edit_tabs'))
            ->renderLayout();
    }
