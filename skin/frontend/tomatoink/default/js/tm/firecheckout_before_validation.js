...
Billing.prototype = {
    initialize: function(){
        ...
        $('billing:country_id') && $('billing:country_id').observe('change', function() {
			if($('billing:country_id').value == 'US'){
				$('ti_hide_billing_state').show();
				$('billing:region_id').value = 'State/Province';
			}else{
				$('ti_hide_billing_state').hide();
			}
...
Shipping.prototype = {
    initialize: function(form) {
        ...
        $('shipping:country_id') && $('shipping:country_id').observe('change', function() {
            if($('shipping:country_id').value == 'US'){
                $('ti_hide_shipping_state').show();
                $('shipping:region_id').value = 'State/Province';
            }else{
                $('ti_hide_shipping_state').hide();
            }
...
ShippingMethod.prototype = {
    ...
    addObservers: function() {
        ...
        $$('#ti_shipping_select option').each(function(el) {
    ...
    getCurrentMethod: function() {
	    var input = $$('#ti_shipping_select option').find(function(el) {
		    return el.selected;
        });
        if (input) {
	        return input.value;
    ...
    validate: function() {
        ...
        var methods = document.getElementsByClassName('test');
        if (methods.length==0) {
