...
if (window.location.href.match("/sales_order/index/")) {
	...
	admin_order_filter.innerHTML = "<br><input type='button' value='Auto Ship' id='order_filter_autoship'><br>";
	admin_order_filter.innerHTML += "<br><input type='button' value='Small Order' id='order_filter_small'><br>";
	admin_order_filter.innerHTML += "<br><input type='button' value='Large Order' id='order_filter_large'><br>";
	admin_order_filter.innerHTML += "<br><input type='button' value='Ready To Ship' id='order_filter_readytoship'><br>";
//position,fixed top,300px; 
	admin_order_filter.style = "display:none;width:100px; height:500px; background-color:white;";
	var admin_filter_block  = document.createElement('div');
	var admin_filter_header = document.createElement('div');
	admin_filter_header.innerHTML = "<p>CAS Filter</p>";
	admin_filter_header.style = "height:30px;width:100px;background-color:white;";
	...
	admin_batch_button.style = "margin-left:95%";
